...
public class premium_suite extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					premium_suite frame = new premium_suite();
	...
	public premium_suite() {
		...
		panel_5.setBackground(new Color(220, 162, 54));
		...
		panel_7.setBackground(new Color(220, 162, 54));
		...
		lblNewLabel.setIcon(new ImageIcon(premium_suite.class.getResource("/Resources/PS1.png")));
		...
		panel_5_1.setBackground(new Color(220, 162, 54));
		...
		panel_7_1.setBackground(new Color(220, 162, 54));
		panel_7_1.setBounds(10, 10, 252, 191);
		panel_4_1.add(panel_7_1);
		
		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setIcon(new ImageIcon(premium_suite.class.getResource("/Resources/PS2.png")));
